...
function PANEL:Init()
  ...
  self.Scroll:DockMargin(0, 24, 0, 0)
...
function PANEL:CreateRow(entity, index)
  local __lauxi0 = self.Template.getListView(entity)
  assert(__lauxi0 ~= nil, "cannot destructure nil value")
  local height, search = __lauxi0.height, __lauxi0.search

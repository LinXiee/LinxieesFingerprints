...
function PANEL:Init()
  ...
  self.Top.Paint = function(pnl, w, h)
    ...
    if (xOffset > 0) then
      draw.RoundedBoxEx(self:GetRounded(), 0, 0, w * 0.4, h, col, true, true, roundedBottom, roundedBottom)
    end
    if col then
      XeninUI:DrawRoundedBoxEx(self:GetRounded(), xOffset, 0, w - xOffset, h, pnl.background, !col, true, !col, roundedBottom)
    else
      draw.RoundedBoxEx(self:GetRounded(), xOffset, 0, w - xOffset, h, pnl.background, !col, true, roundedBottom, roundedBottom)
    end

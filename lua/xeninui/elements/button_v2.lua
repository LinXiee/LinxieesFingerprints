...
function PANEL:Paint( w, h )
	...
	XeninUI:DrawShadowText( self:GetText(), self:GetFont(), self._bLeftAligned and XOffset or self._bRightAligned and w + XOffset or w / 2 + XOffset, self._bTopAligned and YOffset or self._bBottomAligned and ( h + YOffset ) or h / 2 + YOffset, self:GetTextColor(), self._iHorizontalAlignment, self._iVerticalAlignment, 1, 125)
	return true
end

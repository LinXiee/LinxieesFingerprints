...
function PANEL:Paint(w, h)
	XeninUI:MaskInverse(function()
		...
		local x1 = h * (math.Clamp((self.AnimationController - 0.5) * 2, 0, 1))
		surface.DrawRect(h - x1, 0, h, h * 0.5)

		local x2 = h * (math.Clamp(self.AnimationController * 2, 0, 1))
		surface.DrawRect(0, h * 0.5, x2, h * 0.5)
	end, function()
		XeninUI:DrawRoundedBox(6, 0, 0, h, h, self.Color)
	end)
